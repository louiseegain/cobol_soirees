      ...
      *-----------------------------------------------------------------
      *          Procedure de connexion � l'application
      *-----------------------------------------------------------------
       ...
       accueil.
           ...
           .
      *-----------------------------------------------------------------
      *          Procedure permettant de cr�er son compte utilisateur
      *-----------------------------------------------------------------
       creation_compte.
               ...
               IF mdp NOT EQUAL SPACE AND login NOT EQUAL SPACE THEN
                   ...
                   READ futilisateur
                       INVALID KEY
                           ...
                           DISPLAY "---------------------"
                           DISPLAY "Veuillez cr�er votre compte : "
                           PERFORM creation_compte
                       NOT INVALID KEY
